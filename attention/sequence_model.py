...
import attention.seq_labeling as seq_labeling
...
class SequenceModel(object):
    def __init__(self,
        ...
        self.tagging_output, self.tagging_loss,self.attention_weights = seq_labeling_outputs
        self.attention_weights=tf.transpose(self.attention_weights, perm=[1, 0, 2])
